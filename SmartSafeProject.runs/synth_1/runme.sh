...
HD_PWD='C:/Users/Mikeb/OneDrive - Thompson Rivers University/CENG 3010/SmartSafeProject/SmartSafeProject.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SmartSafe.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SmartSafe.tcl
