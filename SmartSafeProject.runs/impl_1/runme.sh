...
HD_PWD='C:/Users/Mikeb/OneDrive - Thompson Rivers University/CENG 3010/SmartSafeProject/SmartSafeProject.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SmartSafe.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SmartSafe.tcl -notrace
